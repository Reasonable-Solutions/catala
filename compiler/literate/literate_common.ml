...
let literal_source_files = function
  ...
  | No -> "kildefiler i dette dokumentet"
...
let literal_disclaimer_and_link = function
  ...
  | Pl ->
    "Niniejszy dokument został opracowany na podstawie zestawu plików \
     ...
     [https://catala-lang.org](https://catala-lang.org)"
  | No ->
    "Dette dokumentet ble produsert fra en samling kildefiler skrevet i \
     språket Catala, der den lovgivende teksten og dataprogramkoden som \
     oversetter den, er blandet sammen. For mer informasjon om metodologien og \
     hvordan man leser koden, vennligst besøk \
     [https://catala-lang.org](https://catala-lang.org). "
